...
exports.UPGRADEURL = self.data.url("upgrade.html");
...
exports.MEDIALOADJSURL = self.data.url("contentscripts/mediaload.js");
exports.PAGESTATSJSURL = self.data.url("contentscripts/pagestats.js");
...
/** Enable mediaload (video + audio) pref. */
exports.MEDIALOAD = 'enablemediaload';

/** Enable mediaload uploads. */
exports.MEDIALOAD_UPLOAD = 'medialoadupload';
